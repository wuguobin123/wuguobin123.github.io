      ...
      <section className="download section" id="download">
        ...
        <div className="download-grid">
          <article className="download-card">
            ...
            <a className="download-link" href="http://119.45.252.25:18080/releases/latest-mac-arm64.dmg">
              下载 .dmg ↗
            </a>
          </article>
          <article className="download-card">
            ...
            <pre className="download-cmd"><code>bash -c "$(curl -fsSL http://119.45.252.25:18080/releases/install-mac.sh)"</code></pre>
            <a className="download-link" href="http://119.45.252.25:18080/releases/latest-mac-x64.dmg">
              下载 .dmg ↗
            </a>
          </article>
          <article className="download-card">
            ...
            <a className="download-link" href="http://119.45.252.25:18080/releases/latest-win-x64.exe">
              下载 .exe ↗
            </a>
          </article>
        </div>
